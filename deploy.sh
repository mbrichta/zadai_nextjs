...
# Env Vars
NEXT_PUBLIC_SUPABASE_URL="https://sunbapgrxxozwcravgcj.supabase.co"
NEXT_PUBLIC_SUPABASE_ANON_KEY="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InN1bmJhcGdyeHhvendjcmF2Z2NqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzQ3MDcwMzMsImV4cCI6MjA1MDI4MzAzM30.GOy_nssgUvPn-WBfOz8V7nviqF76dzHkTip-QPfzcjc"
NEXT_PUBLIC_SAFE_KEY="safe-key" # for the demo app
DOMAIN_NAME="mathiasbrichta.com" # replace with your own
EMAIL="mathias.brichta@hotmail.com" # replace with your own

# Script Vars
REPO_URL="https://github.com/mbrichta/zadai_nextjs.git"
APP_DIR=~/zadai-nextjs
